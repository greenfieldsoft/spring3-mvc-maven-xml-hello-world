...
LABEL maintainer="subhrodip.mohanta@greenfieldsoft.com"
LABEL from="GreenField Software Pvt. Ltd. greenfieldsoft.com"
LABEL product="TEST System"
LABEL for="TEST"
LABEL oem="TEST"
LABEL module="TEST application"
...
# copy *.war for the Web Archive (OUR APPLICATION) 
